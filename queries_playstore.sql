...
SELECT app_name , price ,reviews FROM analytics WHERE price BETWEEN 0.1 and 1.0 ORDER BY reviews DESC LIMIT 10;
...
SELECT app_name, current_version FROM analytics WHERE current_version =( SELECT MIN(current_version) FROM analytics) ;
